    ...
    <div>
              ...
              <div key={loan.id} id={loan.id} className="scroll-mt-20">
                ...
                >
                  ...
                  >
                    ...
                    <Link
                      to={loan.link}
                      className="inline-flex items-center bg-[#3870A6] hover:bg-[#2f5a84] text-white px-6 py-3 rounded-md font-medium transition-colors duration-300"
                    >
                      Apply Now
      ...
      <section className="py-16 rounded-3xl text-black">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link
            to="/apply"
            className="inline-flex items-center bg-[#3870A6] hover:bg-[#2f5a84] text-white px-8 py-4 rounded-md font-medium text-lg transition-colors duration-300"
          >
            Apply Now
            <ArrowRight className="ml-2 h-5 w-5" />
          </Link>

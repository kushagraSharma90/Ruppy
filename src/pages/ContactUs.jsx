          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl shadow-lg p-8 backdrop-blur-sm border border-gray-100 transition-all duration-300 hover:shadow-xl">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start group">
                  <div className="flex-shrink-0 mt-1 p-3 bg-[#3870a6]/10 rounded-full group-hover:bg-[#3870a6]/20 transition-colors duration-300">
                    <MapPin className="h-5 w-5 text-[#3870a6]" />
                  </div>
                  <div className="ml-4">
                    <p className="text-base font-semibold text-gray-900">Office Address</p>
                    <p className="text-base text-gray-700">
                        E-4020, Solitaire Business Hub, Viman Nagar, Pune, Maharashtra 411014
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-[#3870a6]/10 rounded-full mb-4">
                <MessageSquare className="h-8 w-8 text-[#3870a6]" />
              </div>
              ...
              <button className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-[#3870a6] text-white font-medium rounded-lg shadow-md hover:bg-[#285379] focus:outline-none focus:ring-2 focus:ring-[#3870a6] focus:ring-offset-2 transition-all">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl">
              <div className="p-8 md:p-10">
                <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
                  <span className="bg-[#3870a6]/10 text-[#3870a6] p-2 rounded-lg mr-3">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      type="submit"
                      className="inline-flex items-center px-6 py-3 bg-[#3870a6] text-white font-medium rounded-lg shadow-md hover:bg-[#285379] focus:outline-none focus:ring-2 focus:ring-[#3870a6] focus:ring-offset-2 transition-all"
                    >
                      Send Message
                    </button>
                  </div>
        ...
        <div className="relative mt-20 mb-16 px-4">
          <div className="relative max-w-6xl mx-auto py-16">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 bg-[#3870a6]/10 rounded-full px-4 py-2 mb-6">
                <div className="w-2 h-2 bg-[#3870a6] rounded-full animate-pulse"></div>
            ...
            <div className="text-center mt-16 bg-[#f5f5ec]">
              <div className="inline-flex items-center gap-2 text-sm text-gray-500">
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div key={i} className="w-8 h-8 rounded-full bg-[#3870a6] border-2 border-white"></div>
                  ))}
                </div>

...
const ContactMap = () => {
  ...
  useEffect(() => {
    ...
    //   center: { lat: 40.7047, lng: -74.0094 },
    //   zoom: 15,
    // })

    // For this example, we'll create a more visually appealing placeholder
    if (mapRef.current) {
        ...
        <div class="w-full h-full relative overflow-hidden">
          ...
          <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
            ...
            <div class="bg-white px-4 py-2 rounded-lg shadow-md">
              <p class="text-gray-800 font-medium">123 Financial District, NY</p>
            </div>
          </div>
